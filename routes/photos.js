		 ...
		 oracle.connect(connectData, function(err, connection) {
			    if ( err ) {
			    	...
			    	console.log("executing the query....");
				  	connection.execute("select O.url, P.objectId  from Object O, Pin P where O.type='photo' and P.sourceId=O.source and P.login ='" + userID + "' and P.board = '" + boardName + "' and P.objectId = O.id", 
				  			   [], 
