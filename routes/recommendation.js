...
function query_db_recommendation(res) {
	  oracle.connect(connectData, function(err, connection) {
	    if ( err ) {
	    	...
	    	var subquery5="(SELECT Object.id, object.url, object.source FROM Object, (select * from (select "+
	    	...
	    	var subquery6="(SELECT Object.id, object.url, object.source FROM Object, (select * from (select "+
	    	...
	    	var subquery7="(SELECT Object.id, object.url, object.source FROM Users, Pin, Object  "+
