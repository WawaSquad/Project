...
function query_db_recommendation(res) {
	  oracle.connect(connectData, function(err, connection) {
	    if ( err ) {
	    	...
	    	var subquery4="(SELECT Object.id, object.url FROM Users, Pin, Object  "+
	    	...
	    	var query="SELECT * FROM (SELECT * FROM ("+subquery1+" UNION "+subquery2+" UNION "+subquery3+" MINUS "+subquery4+") ORDER BY dbms_random.value) WHERE ROWNUM<=5"
	    	console.log(query);
